...
Client → Server:
  {"id": "req-1", "type": "scan",         "params": {"duration": 5}}
  {"id": "req-2", "type": "connect",      "params": {"address": "...", "name": "...", "device_type": "toy"}}
  {"id": "req-3", "type": "disconnect",   "params": {"address": "..."}}
  {"id": "req-4", "type": "command",      "params": {"address": "...", "action": "set_mode", "data": {...}}}
  {"id": "req-5", "type": "list_devices", "params": {}}

Server → Client (responses):
  {"id": "req-1", "ok": true, "devices": [...]}

Server → Client (device events, broadcast to all connected WS clients):
  {"type": "event", "address": "...", "event": "connected",    "data": {...}}
  {"type": "event", "address": "...", "event": "disconnected", "data": {...}}
  {"type": "event", "address": "...", "event": "battery",      "data": {"level": 80}}
  {"type": "event", "address": "...", "event": "device_info",  "data": {...}}
  {"type": "event", "address": "...", "event": "error",        "data": {"message": "..."}}
"""
